...
using static SPSL.Language.Analysis.Exceptions.SemanticException;
using static SPSL.Language.Core.SPSLParser;
using BoolLiteral = SPSL.Language.Parsing.AST.BoolLiteral;
using DoubleLiteral = SPSL.Language.Parsing.AST.DoubleLiteral;
using FloatLiteral = SPSL.Language.Parsing.AST.FloatLiteral;
using IntegerLiteral = SPSL.Language.Parsing.AST.IntegerLiteral;
using StringLiteral = SPSL.Language.Parsing.AST.StringLiteral;
using UnsignedIntegerLiteral = SPSL.Language.Parsing.AST.UnsignedIntegerLiteral;
...
public class SymbolVisitor : SPSLBaseVisitor<Symbol>
{
    ...
    public override Symbol VisitPermutationVariableBool([NotNull] PermutationVariableBoolContext context)
    {
        SymbolTable permutation = new()
        {
            ...
            {
                new PermutationTypeModifier(PermutationVariableType.Bool)
            }
        };
    ...
    public override Symbol VisitPermutationVariableInteger([NotNull] PermutationVariableIntegerContext context)
    {
        SymbolTable permutation = new()
        {
            ...
            Modifiers = new List<ISymbolModifier>
            {
                new PermutationTypeModifier(PermutationVariableType.Integer)
            }
        };
